...
interface PersonListClientProps {
    initialPersons: Person[];
    initialCount: number;
}

const PersonListClient = ({ initialPersons, initialCount }: PersonListClientProps) => {
    const [personList, setPersonList] = useState<Person[]>(initialPersons || []);
    ...
    useEffect(() => {
        if (data?.listPersons?.data) {
            ...
            if (data.listPersons.count !== undefined && data.listPersons.count !== null) {
                setTotalCount(data.listPersons.count);
            }
        }
    }, [data]);
...
export default PersonListClient;
